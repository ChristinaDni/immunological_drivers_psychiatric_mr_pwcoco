...
instruments<- read.table("instruments_eqtlgen.txt", header=T)
...
setwd("/dir/proteomewide/eqtlgen/inflammation/results/mr")
if(file.exists("ivw_primary_eqtlgen.txt") == TRUE) {
  write.table(final_ivw_res_primary,"ivw_primary_eqtlgen.txt", sep="\t", quote=F, row.names=F, col.names=F, append=TRUE)
} else { 
  write.table(final_ivw_res_primary, "ivw_primary_eqtlgen.txt", sep="\t", quote=F, row.names=F, append=FALSE)
}
...
if(file.exists("wald_primary_eqtlgen.txt") == TRUE) {
  write.table(wald_res_primary,"wald_primary_eqtlgen.txt", sep="\t", quote=F, row.names=F, col.names=F, append=TRUE)
} else { 
  write.table(wald_res_primary, "wald_primary_eqtlgen.txt", sep="\t", quote=F, row.names=F, append=FALSE)
}
}
...
if(file.exists("ivw_secondary_eqtlgen.txt") == TRUE) {
  write.table(final_ivw_res_secondary,"ivw_secondary_eqtlgen.txt", sep="\t", quote=F, row.names=F, col.names=F, append=TRUE)
} else { 
  write.table(final_ivw_res_secondary, "ivw_secondary_eqtlgen.txt", sep="\t", quote=F, row.names=F, append=FALSE)
}
...
if(file.exists("wald_secondary_eqtlgen.txt") == TRUE) {
  write.table(wald_res_secondary,"wald_secondary_eqtlgen.txt", sep="\t", quote=F, row.names=F, col.names=F, append=TRUE)
} else { 
  write.table(wald_res_secondary, "wald_secondary_eqtlgen.txt", sep="\t", quote=F, row.names=F, append=FALSE)
}
}
