...
cd /path/METABRAIN/PWCOCO/regions/outcome
mkdir adhd
cd /path/METABRAIN/PWCOCO/results
mkdir adhd


BASEDIR="/path/METABRAIN/PWCOCO/regions/exposure"
OUTDIR="/path/METABRAIN/PWCOCO/regions/outcome/adhd"
OUTDAT="/path/psychiatric_data/C_adhd_2022.txt"
TOPHITSDIR="/path/METABRAIN/PWCOCO/regions/topregions_metabrain.txt" #This file was created during region extraction for the eQTLs- it helps loop over pwcoco
...
--chr $j --maf 0.01 --out "/path/METABRAIN/PWCOCO/results/adhd/adhd_metabrain.out"
shift
done
